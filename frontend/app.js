...
function grooveTips(core){
  ...
  tips.push(`Solid? Go drum with a band: <a href="https://drummate.app/?utm_source=chart&utm_medium=app&utm_campaign=teach-tip" target="_blank" rel="noopener"><b>DrumMate</b></a> is a live band that follows you, on any kit — electronic, pads or acoustic.`);
  return tips;
}
